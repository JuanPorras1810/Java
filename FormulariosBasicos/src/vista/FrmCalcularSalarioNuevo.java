...
import modelo.ClsCalcularSalarioNuevo;

/**
 *
 * @author Juan Porras
 */
public class FrmCalcularSalarioNuevo extends javax.swing.JFrame {

    /**
     * Creates new form FrmCalcularSalarioNuevo
     */
    public FrmCalcularSalarioNuevo() {
        initComponents();
    }
// Declaracion de variables 
    ClsCalcularSalarioNuevo objClsCalcularSalarioNuevo = new ClsCalcularSalarioNuevo();

//Metodos
    public void capturar() {
        if (TxtSalario.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Debe digitar el salario");
        } else if (TxtPorcentaje.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Debe digitar el porcentaje de incremento");
        } else {
            objClsCalcularSalarioNuevo.setSalario(Integer.parseInt(TxtSalario.getText()));
            objClsCalcularSalarioNuevo.setPorcentajeIncremento(Integer.parseInt(TxtPorcentaje.getText()));
        }
    }

    public void calcular() {
        this.capturar();
        objClsCalcularSalarioNuevo.CalcularSalario();
        TxtNuevoSalario.setText("" + objClsCalcularSalarioNuevo.getNuevoSalario());
    }

    public void limpiar() {
        TxtSalario.setText(null);
        TxtPorcentaje.setText(null);
        TxtNuevoSalario.setText(null);
    }
    ...
    private void initComponents() {
        ...
        setTitle("Formulario para calcular aumento de salario");
        setResizable(false);
        ...
        BtnCalcular.setToolTipText("Calcular nuevo salario ");
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(TxtNuevoSalario, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmCalcularSalarioNuevo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmCalcularSalarioNuevo().setVisible(true);
            }
        });
    }
