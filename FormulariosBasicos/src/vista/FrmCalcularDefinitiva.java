...
import modelo.ClsCalcularDefinitiva;

/**
 *
 * @author Juan Porras
 */
public class FrmCalcularDefinitiva extends javax.swing.JFrame {

    /**
     * Creates new form CalcularDefinitiva
     */
    public FrmCalcularDefinitiva() {
        initComponents();
    }

//Declaracion de variables
    ClsCalcularDefinitiva objClsCalcularDefinitiva = new ClsCalcularDefinitiva();

//Metodos
    public void capturar() {
        if (TxtNota1.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Debe digitar la nota 1");
        } else if (TxtNota2.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Debe digitar la nota 2");
        } else if (TxtNota3.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Debe digitar la nota 3");
        } else {
            objClsCalcularDefinitiva.setNota1(Integer.parseInt(TxtNota1.getText()));
            objClsCalcularDefinitiva.setNota2(Integer.parseInt(TxtNota2.getText()));
            objClsCalcularDefinitiva.setNota3(Integer.parseInt(TxtNota3.getText()));
        }
    }

    public void calcular() {
        this.capturar();
        objClsCalcularDefinitiva.CalcularDefinitiva();
        TxtSuma.setText("" + objClsCalcularDefinitiva.getSuma());
    }
    ...
    private void initComponents() {
        ...
        setTitle("Formulario para calcular la definitiva");
        setResizable(false);
        ...
        BtnCalcular.setToolTipText("Calcular la definitiva");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmCalcularDefinitiva.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmCalcularDefinitiva().setVisible(true);
            }
        });
    }
